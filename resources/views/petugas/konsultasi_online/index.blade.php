                    ...
                    <tr class="border-b border-slate-100 dark:border-slate-700 hover:bg-emerald-50/30 transition-colors">
                        ...
                        <td class="p-6 text-center">
                            ...
                            @elseif($item->status == 'dikonfirmasi')
                                <div class="flex justify-center gap-2">
                                    <a href="{{ $item->link_google_meet }}" target="_blank" class="bg-emerald-600 text-white py-2 px-4 rounded-xl font-black text-[10px] uppercase hover:bg-emerald-700 transition-all shadow-md"><i class="fas fa-video mr-1"></i> Gabung</a>
                                    <form action="{{ route('petugas.konsultasi.selesaikan', $item->id_konsultasi) }}" method="POST">
                                        @csrf <button type="submit" class="bg-red-600 text-white py-2 px-4 rounded-xl font-black text-[10px] uppercase hover:bg-red-700 transition-all shadow-md">Selesai</button>
                                    </form>
                                </div>
                            @else
