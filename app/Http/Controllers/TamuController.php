...
class TamuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Logout setelah simpan agar sesi bersih untuk tamu berikutnya
            Auth::guard('tamu')->logout();

            // Tentukan route sukses
            $routeName = ($result['tamu']->wasRecentlyCreated) ? 'tamu.success_baru' : 'tamu.success_lama';
